<nav class="navbar navbar-dark">
    <ul class="text-uppercase">
        <li><a href="../WEB-PHP/view/tugas/create.php">Upload</a></li>
    ...
    <div class="dropdown profile">
        <button class="btn btn-secondary" type="button" id="droptog" data-bs-toggle="dropdown" aria-expanded="false">
            <div class="image">
                <span class="mr-10px"><?= htmlspecialchars($user['username']); ?></span>
                <img
                    src="../../WEB-PHP/assets/upload/<?= !empty($user['gambar']) ? $user['gambar'] : 'default.jpg' ?>"
                    alt="Profile"
                    class="profile-img">
            </div>
        </button>
